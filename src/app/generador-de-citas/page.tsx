...
export const metadata: Metadata = {
  ...
  description: 'Generá citas bibliográficas en APA 7ª, MLA 9 y Chicago gratis. Buscá por DOI, ISBN o URL. Sin registro. Generador de referencias académicas en español para estudiantes y profesores.',
