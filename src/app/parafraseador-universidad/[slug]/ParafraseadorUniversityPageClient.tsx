    ...
    <div className="min-h-screen bg-white pb-10 px-2">
      ...
      <section className="w-full flex flex-col items-center justify-center pt-6 pb-8 px-4 relative overflow-hidden">
        ...
        <p className="text-base md:text-lg text-gray-600 text-center mb-6 max-w-2xl animate-fade-in" style={{animationDelay: '0.2s'}}>
          Reescribe textos académicos con tus propias palabras. Especializado para trabajos de {university.name} en {university.city}. Evitá el plagio manteniendo el significado.
        </p>

        <a
          href="/parafraseador"
          className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-emerald-500 to-violet-600 hover:from-emerald-600 hover:to-violet-700 text-white font-bold rounded-xl shadow-md hover:shadow-lg transition-all duration-300 animate-fade-in text-lg"
      ...
      <section className="max-w-5xl mx-auto mb-16 px-4">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="bg-slate-50 rounded-xl p-6 mt-8 border-2 border-slate-200">
            ...
            <a
              href="/parafraseador"
              className="inline-block bg-gradient-to-r from-emerald-500 to-violet-600 text-white font-bold py-3 px-8 rounded-xl hover:shadow-lg transition-all"
            >
