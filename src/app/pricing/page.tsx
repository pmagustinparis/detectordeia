...
export const metadata: Metadata = {
  ...
  description: 'Elige el plan perfecto para ti. Plan Free gratis, Plan Express $3.99/24h para entregas urgentes, o Plan Premium $12.99/mes con usos ilimitados y 5 modos premium. Detector, Humanizador y Parafraseador de IA en español.',
  alternates: {
    canonical: 'https://detectordeia.ai/pricing',
  },
  openGraph: {
    title: 'Planes | Detector de IA - DetectordeIA.ai',
    description: 'Plan Free gratis, Plan Express $3.99/24h, Plan Premium $12.99/mes con usos ilimitados. Detector, Humanizador y Parafraseador de IA en español.',
