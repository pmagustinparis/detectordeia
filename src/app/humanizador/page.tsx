          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Express Pass ($3.99 por 24 horas o $8.99 por 7 días) te da acceso ilimitado a todas las herramientas con 5 modos, subida de archivos y sin límite de caracteres - perfecto para entregas urgentes. Es un pago único sin renovación automática.',
                },
              },
              {
                '@type': 'Question',
