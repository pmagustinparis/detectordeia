  ...
  return (
    <div className="min-h-screen pb-10 px-2">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-blue-50 rounded-xl border border-blue-200 p-8">
            <div className="text-center mb-6">
              ...
              <div className="text-4xl font-bold text-blue-900 mb-2">{comparison.pricing.detectordeia}</div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-8">
            <div className="text-center mb-6">
              ...
              <div className="text-4xl font-bold text-gray-700 mb-2">{comparison.pricing.competitor}</div>
          ...
          {comparison.faqs.map((faq, index) => (
            ...
            >
              <summary className="font-bold text-lg text-gray-800 cursor-pointer list-none flex items-center justify-between">
                ...
                <svg className="w-5 h-5 text-blue-900 transition-transform group-open:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-5xl mx-auto px-4 text-center text-sm text-gray-500">
        ...
        <Link href="/parafraseador" className="hover:text-blue-900 transition-colors">Parafraseador</Link>
        <span className="mx-2">›</span>
