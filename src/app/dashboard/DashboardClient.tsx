      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-gray-50 rounded-xl shadow-sm p-4 mb-6 border border-gray-200">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-cyan-500 flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex-1">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 text-cyan-600 hover:text-cyan-700 font-semibold text-sm transition-colors"
              >
