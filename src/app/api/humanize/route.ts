      ...
      return NextResponse.json(
        {
          ...
          message: `El modo "${HUMANIZER_MODES[selectedMode].name}" requiere Express Pass o Semestral Pass. Activá un plan para acceder a todos los modos de humanización.`,
          mode: selectedMode,
