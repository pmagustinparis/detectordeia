      ...
      return NextResponse.json(
        {
          ...
          message: `El modo "${PARAPHRASER_MODES[selectedMode].name}" requiere Express Pass o Semestral Pass. Activá un plan para acceder a todos los modos de parafraseo.`,
          mode: selectedMode,
